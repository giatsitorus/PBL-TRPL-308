...
class TechnicianAddPage extends StatefulWidget {
  const TechnicianAddPage({super.key});

  @override
  State<TechnicianAddPage> createState() => _TechnicianAddPageState();
}

class _TechnicianAddPageState extends State<TechnicianAddPage> {
  File? _image;
  ...
  String? phoneNumberValidator(String? value) {
   ...
   Future<void> addUser() async {
    var userData = FormData.fromMap({
      ...
      if (_image != null) 'image': await MultipartFile.fromFile(
        _image!.path,
                ...
                children: [
                    ...
                    child: Stack(
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: _image == null ? NetworkImage('https://photosking.net/wp-content/uploads/2024/05/no-dp_16.webp') : FileImage(_image!),
                        ),
                        Positioned(
                          right: 5,
                          bottom: 5,
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Tim', style: TextStyle(fontSize: 12, color: Colors.black54),),
                        SizedBox(height: 4,),
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            underline: SizedBox(),
                            items: _technicianTeams.map<DropdownMenuItem<String>>((Map<dynamic, dynamic> team) {
                              return DropdownMenuItem<String>(
                                value: team['id'].toString(), 
                                child: Text(team['name'] ?? "No Name"),
                              );
                            }).toList(),
                          ),
                        )
              ...
              child: Container(
                ...
                child: InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('Tambah Teknisi', style: TextStyle(color: Colors.white, fontSize: 14))
                    ],
                  ),
                ),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child:Text('Berhasil menambahkan data teknisi baru!', textAlign: TextAlign.center, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500),),
                ),
                Row(
